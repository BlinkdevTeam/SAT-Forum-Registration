...
import LeftColumn2 from "../components/LeftColumnManual17_2";
...
export default function PersonalInfoForm() {
  ...
  useEffect(() => {
    // Always set participation_type to "onsite"
    // Always set selectedEvents to ["event1"]
    setFormData((prev) => ({
      ...prev,
    ...
    try {
      const response = await fetch("https://api.me-qr.com/qr", {
        ...
        headers: {
          ...
          "x-api-key":
            "f4910ec48a1f1481b4bd5ea250fa899da010cd2611dd5c2fdbf7f24ecfac541e",
        },
        body: JSON.stringify({
                    ...
                    <div className="grid gap-6 text-black">
                      ...
                      <div>
                        ...
                        <div className="flex flex-col gap-2">
                          ...
                          <span
                            className={`text-[12px] text-red-500 transition-opacity duration-200 ${
                              formErrors.cellphone ? "opacity-100" : "opacity-0"
                            }`}
                          >
