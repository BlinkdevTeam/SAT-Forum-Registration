            ...
            <div className="w-full flex flex-col gap-12">
              <div className="flex flex-col gap-8">
                ...
                <p className="text-[18px] leading-[23px]">
                  ...
                  production—delivering expert insights that drive real-world
                  gains.
                </p>
              </div>
                                ...
                                <div className="flex flex-col justify-start items-center gap-6">
                                  <div
                                    className={`w-[84px] h-[84px] rounded-full flex items-center justify-center ${
                                      formData.selectedEvents?.includes(
                                        "event1"
                                      )
                                        ? "bg-[#007AFF]"
                                        : "bg-[#E5E3DE]"
                                  ...
                                  <div className="flex gap-4">
                                    ...
                                    >
                                      July 17, 2025 | Future Laid: Innovation
                                      Beyond the Shell
                                    </label>
                                  </div>
                                </div>
                                ...
                                <div className="flex flex-col justify-start items-center gap-6">
                                  ...
                                  <div className="flex gap-4">
                                    ...
                                    <label
                                      ...
                                      className="text-[14px] text-gray-700"
                                    >
                                      July 24, 2025 | Beyond the Pen:
                                      Reimagining Swine Through Innovation
                                    </label>
                                  </div>
                                </div>
                              </div>
              ...
              <div className="flex flex-col gap-8 text-center lg:text-start">
                <div className="flex flex-col justify-center items-center lg:justify-start lg:items-start gap-4">
                  <h4 className="text-[20px] leading-[24px] tracking-[10px]">
                    JULY 17, 2025
                  </h4>
                  <h4
                    className="text-[20px] lg:leading-[14px]"
                    style={{ fontWeight: 700 }}
                  >
                    Future Laid: Innovation Beyond the Shell
                  </h4>
                  <div
              ...
              <div className="flex flex-col gap-8 text-center lg:text-start">
                <div className="flex flex-col justify-center items-center lg:justify-start lg:items-start gap-4">
                  ...
                  <h4
                    ...
                    style={{ fontWeight: 700 }}
                  >
                    Beyond the Pen: Reimagining Swine Through Innovation
                  </h4>
                  <div
                    className="w-40 h-1 rounded"
                    style={{
